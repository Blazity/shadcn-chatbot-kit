...
export const Index: Record<string, any> = {
    ...
    "chat": {
      name: "chat",
      type: "registry:ui",
      registryDependencies: ["button","http://localhost:3333/r/chat-message.json","http://localhost:3333/r/message-input.json","http://localhost:3333/r/message-list.json","http://localhost:3333/r/prompt-suggestions.json","http://localhost:3333/r/use-auto-scroll.json"],
    ...
    "message-input": {
      name: "message-input",
      type: "registry:ui",
      registryDependencies: ["http://localhost:3333/r/use-autosize-textarea.json"],
    ...
    "copy-button": {
      name: "copy-button",
      type: "registry:ui",
      registryDependencies: ["button","http://localhost:3333/r/use-copy-to-clipboard.json"],
